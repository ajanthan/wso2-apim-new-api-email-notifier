...
/**
 * @scr.component name="org.wso2.apimgt.notifier.apistate.services" immediate="true"
 ...
 */
public class APINotificationComponent {
    //TODO refactor caching implementation

    private static final Log log = LogFactory.getLog(APINotificationComponent.class);
